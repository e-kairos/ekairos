...
export default defineConfig({
  resolve: {
    alias: [
      {
        find: "@ekairos/domain/runtime",
        replacement: resolve(__dirname, "..", "..", "domain", "src", "runtime.ts"),
      },
      {
        find: "@ekairos/domain",
  ...
  test: {
    ...
    reporters: ["default"],
    include: ["repro/**/*.workflow.integration.test.ts"],
    globalSetup: ["./repro/vitest.workflow.setup.mts"],
