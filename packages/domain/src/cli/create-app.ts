...
function buildNextTemplateFiles(params: {
  ...
  return {
    ...
    "src/app/.well-known/ekairos/v1/domain/route.ts": [
      "// @ekairos/domain-route",
      'import * as __ekairosBootstrap from "../../../../../runtime";',
    ...
    "src/app/domain-showcase.tsx": [
      ...
      "    setError(null);",
      "    try {",
      "      const manifestData = await requestJson<DomainManifest>('/.well-known/ekairos/v1/domain', { method: 'GET' });",
      "      setManifest(manifestData);",
      "",
      "      const queryData = await requestJson<{ data?: { app_tasks?: TaskRow[] } }>('/.well-known/ekairos/v1/domain', {",
      "        method: 'POST',",
      "        body: JSON.stringify({",
      "          op: 'query',",
      "          query: {",
      ...
      "    setError(null);",
      "    try {",
      "      const result = await requestJson('/.well-known/ekairos/v1/domain', {",
      "        method: 'POST',",
      ...
      "            </button>",
      "          </div>",
      '          <p className="muted">The UI calls the same well-known domain endpoint your CLI uses.</p>',
