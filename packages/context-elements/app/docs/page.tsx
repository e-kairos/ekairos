    ...
    <div className="container docs-shell">
      ...
      <main className="docs-main">
        <header className="card doc-top">
          <h1>Documentation</h1>
          <p>
            Catalog aligned with AI Elements and adapted for Ekairos Context.
...
{`curl http://localhost:3040/api/registry/registry.json`}
        ...
        <section id="context-integration" className="card section">
          <div className="section-head">
            <h2 className="section-title">Context Integration</h2>
