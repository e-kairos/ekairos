  ...
  const button = (
    <button
      ...
      className={cn(
        ...
        isGhost
          ? "border-transparent bg-transparent text-slate-500 shadow-none hover:bg-slate-50 hover:text-slate-800 data-[active=true]:border-blue-200 data-[active=true]:bg-blue-50 data-[active=true]:text-blue-700"
